...
CHAPTER_FILES=(
    ...
    "04-context-tiering.html"
    "05-agent-system.html"
    "06-signal-classification.html"
    "07-incremental-refresh.html"
    "08-specs-and-plans.html"
    "09-implementation.html"
    "10-review-pipeline.html"
    "11-managing-tracks.html"
    "12-deep-review.html"
    "13-bug-hunt.html"
    "14-coverage.html"
    "15-pattern-learning.html"
    "16-decomposition.html"
    "17-adrs.html"
...
CHAPTER_PRIORITIES=(
    "0.8" "0.7" "0.7" "0.8" "0.6" "0.6" "0.6" "0.6"
    "0.7" "0.7" "0.7" "0.6" "0.7" "0.7" "0.6" "0.6"
...
generate_sidebar() {
    ...
    local parts=(
        "Introduction|0|0"
        "I. Foundation|1|3"
        "II. How Draft Thinks|4|7"
        "III. Track Lifecycle|8|11"
        "IV. Quality|12|15"
        "V. Architecture|16|17"
        "VI. Enterprise|18|20"
        "VII. Closing|21|21"
        "Appendix|22|23"
    )
...
LANDING_MAIN_START
    ...
    for ((i=0; i<NUM_CHAPTERS; i++)); do
        ...
        elif (( i >= 4 && i <= 7 )); then part="II. How Draft Thinks"
        elif (( i >= 8 && i <= 11 )); then part="III. Track Lifecycle"
        elif (( i >= 12 && i <= 15 )); then part="IV. Quality"
        elif (( i >= 16 && i <= 17 )); then part="V. Architecture"
        elif (( i >= 18 && i <= 20 )); then part="VI. Enterprise"
        elif (( i == 21 )); then part="VII. Closing"
        else part="Appendix"
        fi
